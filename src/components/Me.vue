    ...
    <section class="me" @touchstart="touchStartHideAll">
        ...
        <section class="me_deatil" @click="showDefaultName">
            ...
            <div class="name" >
              ...
              <div @click="setup" class="setup">
                <i class="iconfont icon-shezhi"></i>
                设置
              </div>
              <div @click="profile" class="profile">
        ...
        <section class="like_list list">
            ...
            <ul>
                <li :key="likeList.id" v-for="likeList in likeLists[0]">
                    <router-link :to="'/dishes/'+likeList.dishId">
                        <img v-lazy="baseUrl+likeList.dishImage" alt="">
                        <h4>{{likeList.dishName}}</h4>
                        <div>
        ...
        <section class="comment list">
            ...
            <ul>
                <li :key="comment.id"  v-for="(comment,index) in comments">
                    ...
                    <div class="delete" @click="deleteComment(comment.id,Email,index,$event)">删除</div>
                </li>
            </ul>
        </section>
    </section>
